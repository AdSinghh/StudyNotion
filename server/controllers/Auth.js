...
const OTP = require("../models/OTP"); // OTP model for OTP operations
const jwt = require("jsonwebtoken"); // For creating JWT tokens
const otpGenerator = require("otp-generator"); // For generating OTPs
const mailSender = require("../utils/mailSender"); // For sending emails
const { passwordUpdated } = require("../mail/templates/passwordUpdate"); // Email template for password updates
const Profile = require("../models/Profile"); // Profile model for user profiles
...
exports.signup = async (req, res) => {
  try {
    ...
    // Determine if the user needs to be approved
    let approved = "";
